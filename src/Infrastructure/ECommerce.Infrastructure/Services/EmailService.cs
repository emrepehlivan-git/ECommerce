...
public sealed class EmailService : IEmailService, IScopedDependency
{
    ...
    private readonly Application.Common.Logging.IECommerceLogger<EmailService>? _logger;

    public EmailService(IConfiguration configuration, Application.Common.Logging.IECommerceLogger<EmailService>? logger = null)
    {
